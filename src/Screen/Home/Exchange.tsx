                    ...
                    <View style={styles.card_each}>
                        <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                            ...
                            <Picker
                                ...
                                style={[styles.picker, { height: 50 }]} 
                                onValueChange={(itemValue) => setChangeUnit(itemValue)}
                            >
                                {convertUnit.map((changeUnit) => (
                                <Picker.Item key={changeUnit.value} label={changeUnit.label} value={changeUnit.value} />
                                ))}
                            </Picker>
                            </View>
                            <TextInput 
